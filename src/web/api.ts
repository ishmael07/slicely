...
/** What the server will say about the signed-in person. Mirrors the wire's
 *  `AccountView`; nothing secret is in it — an email, a letter, four integers
 *  and two pre-formatted strings. */
export interface AccountView {
  ...
  /** "$0.42" — formatted once, on the server. */
  balanceLabel: string;
