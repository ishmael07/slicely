...
| 🎨 **Multi-colour, one part** | Give a SINGLE model several colours without painting it: Slicely bands it by height and pauses for a filament swap at each boundary. Works on **any** printer, including single-extruder machines with no AMS. |
